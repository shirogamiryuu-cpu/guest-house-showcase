  ...
  return (
    <section className="bg-white px-5 py-10 md:px-8 md:py-14 lg:px-21.25 lg:py-16">
      <div className="mx-auto flex max-w-360 flex-col items-center gap-8 lg:flex-row lg:gap-16">
        ...
        <div className="hidden h-88 w-0 shrink-0 border-l border-[#3343a5]/20 lg:block" />
        ...
        >
          <h1 className="font-serif text-4xl font-bold leading-[1.2] text-[#131a3f] sm:text-5xl md:text-6xl">
            Best Selling Products
          </h1>
          <button className="rounded-[15px] bg-[#131a3f] px-8 py-4 font-serif text-lg text-white shadow-[0_4px_3.5px_rgba(0,0,0,0.25)] transition-opacity hover:opacity-90 md:text-xl">
            Contact Us
          </button>
        </motion.div>
      </div>
